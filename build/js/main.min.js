...
/* harmony import */ var _modules_menu_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu/menu.js */ "./js/modules/menu/menu.js");
/* harmony import */ var _modules_map_map_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/map/map.js */ "./js/modules/map/map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_menu_menu_js__WEBPACK_IMPORTED_MODULE_2__["initBurger"])();
  Object(_modules_map_map_js__WEBPACK_IMPORTED_MODULE_3__["initMap"])();
  // ---------------------------------
...
var initMap = function initMap() {
  ...
  function init() {
    ...
    myMap.balloon.open(myMap.getCenter(), {
      ...
      contentBody: 'Волшебный мир айсбергов и пингвинов' + '<svg xmlns="http://www.w3.org/2000/svg" fill="none" width="10" height="10" viewBox="0 0 18 18"><path fill="#011C40" d="M18 13.42v3.54a1 1 0 0 1-.93 1c-.44.02-.8.04-1.07.04A16 16 0 0 1 .05.93a1 1 0 0 1 1-.93h3.53a.5.5 0 0 1 .5.45A13.52 13.52 0 0 0 6.35 5c.1.2.03.44-.15.57L4.04 7.11a13.05 13.05 0 0 0 6.85 6.85l1.54-2.16a.46.46 0 0 1 .57-.15 13.9 13.9 0 0 0 4.55 1.27.5.5 0 0 1 .45.5Z"/></svg> <a href="tel:+78002000000">8-800-200-00-00</a>' + '<address><svg xmlns="http://www.w3.org/2000/svg" fill="none" width="10" height="10" viewBox="0 0 18 22"><path fill="#011C40" d="M15.364 15.556 9 22l-6.364-6.444a9.149 9.149 0 0 1-2.463-4.665 9.219 9.219 0 0 1 .512-5.266A9.09 9.09 0 0 1 4 1.535 8.921 8.921 0 0 1 9 0c1.78 0 3.52.534 5 1.536a9.089 9.089 0 0 1 3.315 4.09 9.22 9.22 0 0 1 .512 5.264 9.149 9.149 0 0 1-2.463 4.666ZM9 11.138c.53 0 1.04-.214 1.414-.594a2.038 2.038 0 0 0 0-2.864A1.988 1.988 0 0 0 9 7.089c-.53 0-1.04.213-1.414.593C7.21 8.06 7 8.576 7 9.113c0 .537.21 1.052.586 1.431.375.38.884.594 1.414.594Z"/></svg>г. Санкт Петербург, ул.&nbsp;Большая&nbsp;Конюшенная, 19/8</address>'
    });
    myMap.hint.open([59.938635, 30.323118], "\u0417\u0430\u0431\u0440\u043E\u043D\u0438\u0440\u0443\u0439\u0442\u0435 \u0442\u0443\u0440 \u0437\u0430 3 6 \u043C\u0435\u0441\u044F\u0446\u0435\u0432 \u0434\u043E \u0434\u0430\u0442\u044B \u0432\u044B\u0435\u0437\u0434\u0430 \u0438 \u0441\u044D\u043A\u043E\u043D\u043E\u043C\u044C\u0442\u0435 \u0434\u043E 50%");
    var placemark = new YMaps.Placemark(new YMaps.GeoPoint(59.938635, 30.323118));
...
/*!*********************************!*\
  !*** ./js/modules/menu/menu.js ***!
  \*********************************/
/*! exports provided: initBurger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initBurger", function() { return initBurger; });
...
var _scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();
var menuBtn = document.querySelector('.menu__button');
var menu = document.querySelector('.header__container');
var menuOverlay = document.querySelector('.header__overlay');
