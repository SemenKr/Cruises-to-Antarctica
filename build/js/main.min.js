...
var MY_LATITUDE = '59.938635';
var MY_LONGITUDE = '30.323118';
var MAP_CENTER_LATITUDE = '59.94';
var MAP_CENTER_LONGITUDE = '30.324';
var myZoomMap = '15';
var initMap = function initMap() {
  ...
  function init() {
    ...
    var placeMark = new ymaps.Placemark([MY_LATITUDE, MY_LONGITUDE], {
      hintContent: '<div class="map__hint"><address>Большая&nbsp;Конюшенная, 19/8</address></div>',
      balloonContent: ['<div class="map__balloon">', '<h3>Круизы в Антарктику</h3>', '<p>Волшебный мир айсбергов и пингвинов</p>', '</div>'].join('')
    }, {
...
var menuBtn = document.querySelector('.header__button');
var menu = document.querySelector('.header__container');
var menuOverlay = document.querySelector('.header__overlay');
var menuLinks = document.querySelector('.header__menu').querySelectorAll('.menu__link');
